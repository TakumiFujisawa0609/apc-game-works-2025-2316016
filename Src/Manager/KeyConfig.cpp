...
void KeyConfig::Init(void)
{
	...
	AddFixed(CONTROL_TYPE::ENTER_TEMP, KEY_INPUT_SPACE);
	AddFixed(CONTROL_TYPE::ENTER_TEMP, KEY_INPUT_RETURN);
	AddFixed(CONTROL_TYPE::ENTER_TEMP, MOUSE::CLICK_LEFT);
	AddFixed(CONTROL_TYPE::ENTER_TEMP, JOYPAD_BTN::RIGHTBUTTON_RIGHT);
	AddFixed(CONTROL_TYPE::ENTER_TEMP, JOYPAD_BTN::RIGHTBUTTON_DOWN);

	AddFixed(CONTROL_TYPE::CANCEL, KEY_INPUT_BACK);
	AddFixed(CONTROL_TYPE::CANCEL_TEMP, JOYPAD_BTN::RIGHTBUTTON_LEFT);
	AddFixed(CONTROL_TYPE::CANCEL_TEMP, JOYPAD_BTN::RIGHTBUTTON_TOP);
