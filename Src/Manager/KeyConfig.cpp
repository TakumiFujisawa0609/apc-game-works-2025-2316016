...
void KeyConfig::Init(void)
{
	...
	//カメラ変更
	Add(CONTROL_TYPE::CHENGE_CAMERA_MODE, MOUSE::CLICK_RIGHT);
	...
	Add(CONTROL_TYPE::PLAYER_MOVE_UP, KEY_INPUT_W);
	Add(CONTROL_TYPE::PLAYER_MOVE_DOWN, KEY_INPUT_S);
	Add(CONTROL_TYPE::PLAYER_MOVE_RIGHT, KEY_INPUT_D);
	Add(CONTROL_TYPE::PLAYER_MOVE_LEFT, KEY_INPUT_A);
	Add(CONTROL_TYPE::PLAYER_AVOID, KEY_INPUT_SPACE);
