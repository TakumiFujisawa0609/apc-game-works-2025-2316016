...
void KeyConfig::Init(void)
{
	...
	Add(CONTROL_TYPE::PLAYER1_MOVE_UP, KEY_INPUT_W);
	Add(CONTROL_TYPE::PLAYER1_MOVE_DOWN, KEY_INPUT_S);
	Add(CONTROL_TYPE::PLAYER1_MOVE_RIGHT, KEY_INPUT_D);
	Add(CONTROL_TYPE::PLAYER1_MOVE_LEFT, KEY_INPUT_A);
	Add(CONTROL_TYPE::PLAYER1_JUMP, KEY_INPUT_LSHIFT);
	Add(CONTROL_TYPE::PLAYER2_MOVE_UP, KEY_INPUT_UP);
	Add(CONTROL_TYPE::PLAYER2_MOVE_DOWN, KEY_INPUT_DOWN);
	Add(CONTROL_TYPE::PLAYER2_MOVE_RIGHT, KEY_INPUT_RIGHT);
	Add(CONTROL_TYPE::PLAYER2_MOVE_LEFT, KEY_INPUT_LEFT);
	Add(CONTROL_TYPE::PLAYER2_JUMP, KEY_INPUT_SPACE);
