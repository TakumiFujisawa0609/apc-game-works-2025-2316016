...
void SceneSetting::Draw(void)
{
    ...
    //音量を描画
	Utility::DrawStringPlace("BGM 音量: " + std::to_string(static_cast<int>(bgmVolume_ * 100.0f)), Application::SCREEN_SIZE_X - MARGIN, MARGIN + 30, 0xffffff, Utility::STRING_PLACE::RIGHT);
	...
	Utility::DrawStringPlace("SE 音量: " + std::to_string(static_cast<int>(seVolume_ * 100.0f)), Application::SCREEN_SIZE_X - MARGIN, MARGIN + 60, 0xffffff, Utility::STRING_PLACE::RIGHT);
